...
import { useUpdateEmployeesInventoryMutationOptions } from "@/api/inventory/employees/inventory.hooks";
...
export function EditEmployeesInventoryModal({
    ...
    const { mutate: updateItem, isPending } = useMutation(useUpdateEmployeesInventoryMutationOptions());
