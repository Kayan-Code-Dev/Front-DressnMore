...
const formSchema = z.object({
  factory_code: z.string().min(1, { message: "أدخل الكود" }),
  name: z.string().min(1, { message: "أدخل الاسم" }),
  inventory_name: z.string().min(1, { message: "أدخل اسم المخزن" }),
  status: z.enum(["نشط", "قيد الإنشاء", "مغلق"]),
  city_id: z.string().min(1, { message: "اختر المدينة" }),
  street: z.string().min(1, { message: "أدخل الشارع" }),
              ...
              <div className="grid grid-cols-2 gap-4">
                  ...
                  render={({ field, fieldState }) => (
                    <FormItem>
                      <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                        كود مصنع <span className="text-red-400">*</span>
                      </label>
                      <FormControl>
                        <input
                          type="text"
                          placeholder="مثال: FAC001"
                          dir="ltr"
                ...
                <FormField
                  ...
                  render={({ field, fieldState }) => (
                    <FormItem>
                      <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                        اسم مصنع <span className="text-red-400">*</span>
                      </label>
                      <FormControl>
                        <input
                          type="text"
                          placeholder="أدخل اسم مصنع..."
                          className={fieldClass(!!fieldState.error)}
                          {...field}
                        />
                      </FormControl>
                      ...
                      <div className="flex gap-2">
                        {statusOptions.map((s) => (
                          <button
                            ...
                            className={`flex-1 py-2.5 rounded-lg text-xs font-semibold border-2 transition-all whitespace-nowrap ${
                              field.value === s
                                ? s === "نشط"
            ...
            <div className="px-6 pb-5 pt-3 flex gap-3 justify-end border-t border-gray-100 shrink-0 bg-white">
              ...
              >
                {isPending ? (
                  ...
                  <>
                    <i className="ri-save-line" /> إضافة مصنع
                  </>
                )}
              </button>
            </div>
